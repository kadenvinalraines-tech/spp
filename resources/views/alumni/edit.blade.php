...
<div class="card shadow-sm">
    <div class="card-header bg-white">
        <h5 class="mb-0">Edit Data Alumni: {{ $student->name }}</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('alumni.update', $student->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <label class="form-label">Terakhir Kelas (Read-only)</label>
                    <input type="text" class="form-control" value="{{ $student->schoolClass->name ?? 'Tidak ada data kelas' }}" readonly disabled>
                    <div class="form-text">Data kelas alumni tidak dapat diubah karena merupakan riwayat terakhir kelulusan.</div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('alumni.index') }}" class="btn btn-secondary me-2">Batal</a>
